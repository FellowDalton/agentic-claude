...
description: Answer questions about example-skill domain without coding
argument-hint: [question]
---

# example-skill Expert - Question Mode

Answer the user's question by analyzing example-skill implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/example-skill/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on example-skill-related functionality
...
- Read the `EXPERTISE_PATH` file to understand example-skill architecture and patterns
