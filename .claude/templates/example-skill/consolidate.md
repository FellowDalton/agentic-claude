...
description: Consolidate example-skill expertise learnings journal into expertise.yaml
---

# Purpose

Apply accumulated learnings from the JSONL journal into the example-skill expertise YAML file.
