...
description: Answer questions about storyblok-admin domain without coding
argument-hint: [question]
---

# storyblok-admin Expert - Question Mode

Answer the user's question by analyzing storyblok-admin implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/storyblok-admin/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on storyblok-admin-related functionality
...
- Read the `EXPERTISE_PATH` file to understand storyblok-admin architecture and patterns
