...
description: Create sprint-reporter-focused implementation plan using expertise context
argument-hint: [user_request]
---

# Purpose

You are operating a Higher Order Prompt (HOP) that creates implementation plans with sprint-reporter expertise. Load expertise before delegating to `/plan`.
...
2. **Execute Planning with Context**
   ...
   - Prioritize sprint-reporter elements in the plan
