...
description: Answer questions about sprint-reporter domain without coding
argument-hint: [question]
---

# sprint-reporter Expert - Question Mode

Answer the user's question by analyzing sprint-reporter implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/sprint-reporter/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on sprint-reporter-related functionality
...
- Read the `EXPERTISE_PATH` file to understand sprint-reporter architecture and patterns
