...
You are operating a Higher Order Prompt (HOP) that creates implementation plans with websocket expertise. Load expertise before delegating to `/plan`.
...
2. **Execute Planning with Context**
   ...
   - Prioritize websocket elements in the plan
