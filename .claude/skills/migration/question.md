...
description: Answer questions about migration domain without coding
argument-hint: [question]
---

# migration Expert - Question Mode

Answer the user's question by analyzing migration implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/migration/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on migration-related functionality
...
- Read the `EXPERTISE_PATH` file to understand migration architecture and patterns
