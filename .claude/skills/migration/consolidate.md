...
description: Consolidate migration expertise learnings journal into expertise.yaml
---

# Purpose

Apply accumulated learnings from the JSONL journal into the migration expertise YAML file.
