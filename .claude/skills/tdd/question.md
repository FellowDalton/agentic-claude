...
description: Answer questions about tdd domain without coding
argument-hint: [question]
---

# tdd Expert - Question Mode

Answer the user's question by analyzing tdd implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/tdd/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on tdd-related functionality
...
- Read the `EXPERTISE_PATH` file to understand tdd architecture and patterns
