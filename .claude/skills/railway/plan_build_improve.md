...
Task(
  ...
  prompt: "Run SlashCommand('/skills:railway:plan [USER_PROMPT]'). Return the path to the generated plan file."
)
```
...
Task(
  subagent_type: "general-purpose",
  prompt: "Run SlashCommand('/skills:railway:self-improve true'). Return the self-improvement report."
)
```
