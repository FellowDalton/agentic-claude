...
description: Answer questions about nextpage domain without coding
argument-hint: [question]
---

# nextpage Expert - Question Mode

Answer the user's question by analyzing nextpage implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/nextpage/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on nextpage-related functionality
...
- Read the `EXPERTISE_PATH` file to understand nextpage architecture and patterns
