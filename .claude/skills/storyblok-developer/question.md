...
description: Answer questions about storyblok-developer domain without coding
argument-hint: [question]
---

# storyblok-developer Expert - Question Mode

Answer the user's question by analyzing storyblok-developer implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/storyblok-developer/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on storyblok-developer-related functionality
...
- Read the `EXPERTISE_PATH` file to understand storyblok-developer architecture and patterns
