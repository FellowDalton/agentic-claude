...
description: Answer questions about frontend-dev domain without coding
argument-hint: [question]
---

# frontend-dev Expert - Question Mode

Answer the user's question by analyzing frontend-dev implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/frontend-dev/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on frontend-dev-related functionality
...
- Read the `EXPERTISE_PATH` file to understand frontend-dev architecture and patterns
