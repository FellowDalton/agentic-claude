...
description: Answer questions about sprint-orchestrator domain without coding
argument-hint: [question]
---

# sprint-orchestrator Expert - Question Mode

Answer the user's question by analyzing sprint-orchestrator implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/sprint-orchestrator/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on sprint-orchestrator-related functionality
...
- Read the `EXPERTISE_PATH` file to understand sprint-orchestrator architecture and patterns
