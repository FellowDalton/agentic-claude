...
description: Answer questions about ibexa-format domain without coding
argument-hint: [question]
---

# ibexa-format Expert - Question Mode

Answer the user's question by analyzing ibexa-format implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/ibexa-format/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on ibexa-format-related functionality
...
- Read the `EXPERTISE_PATH` file to understand ibexa-format architecture and patterns
