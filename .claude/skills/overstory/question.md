...
description: Answer questions about overstory domain without coding
argument-hint: [question]
---

# overstory Expert - Question Mode

Answer the user's question by analyzing overstory implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/overstory/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on overstory-related functionality
...
- Read the `EXPERTISE_PATH` file to understand overstory architecture and patterns
