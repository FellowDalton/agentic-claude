...
description: Answer questions about storyblok-cli domain without coding
argument-hint: [question]
---

# storyblok-cli Expert - Question Mode

Answer the user's question by analyzing storyblok-cli implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/storyblok-cli/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on storyblok-cli-related functionality
...
- Read the `EXPERTISE_PATH` file to understand storyblok-cli architecture and patterns
