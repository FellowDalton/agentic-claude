...
description: Consolidate storyblok-cli expertise learnings journal into expertise.yaml
---

# Purpose

Apply accumulated learnings from the JSONL journal into the storyblok-cli expertise YAML file.
