...
Task(
  ...
  prompt: "Run SlashCommand('/skills:teamwork:plan [USER_PROMPT]'). Return the path to the generated plan file."
)
```
...
Task(
  subagent_type: "general-purpose",
  prompt: "Run SlashCommand('/skills:teamwork:self-improve true'). Return the self-improvement report."
)
```
