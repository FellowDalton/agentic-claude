...
description: Consolidate frontend-tester expertise learnings journal into expertise.yaml
---

# Purpose

Apply accumulated learnings from the JSONL journal into the frontend-tester expertise YAML file.
