...
description: Answer questions about frontend-tester domain without coding
argument-hint: [question]
---

# frontend-tester Expert - Question Mode

Answer the user's question by analyzing frontend-tester implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/frontend-tester/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on frontend-tester-related functionality
...
- Read the `EXPERTISE_PATH` file to understand frontend-tester architecture and patterns
