...
description: Answer questions about frontend-validator domain without coding
argument-hint: [question]
---

# frontend-validator Expert - Question Mode

Answer the user's question by analyzing frontend-validator implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/frontend-validator/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on frontend-validator-related functionality
...
- Read the `EXPERTISE_PATH` file to understand frontend-validator architecture and patterns
