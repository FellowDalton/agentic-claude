...
description: Answer questions about pim-sync domain without coding
argument-hint: [question]
---

# pim-sync Expert - Question Mode

Answer the user's question by analyzing pim-sync implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/skills/pim-sync/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on pim-sync-related functionality
...
- Read the `EXPERTISE_PATH` file to understand pim-sync architecture and patterns
