...
Usage:
  python3 validate_file_contains.py -d specs -e .md --contains "## Task Description" --contains "## Objective"
  python3 validate_file_contains.py --directory output --extension .json --contains '"status":'
...
Frontmatter example:
  hooks:
    Stop:
      - hooks:
          - type: command
            command: "python3 $CLAUDE_PROJECT_DIR/.claude/hooks/validators/validate_file_contains.py -d specs -e .md --contains '## Task Description' --contains '## Objective'"
"""
